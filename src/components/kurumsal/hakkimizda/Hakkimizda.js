    ...
    return (
        ...
        <div class="row" style={{border:"2px dotted white",justify: "center",margin:"20px"}}>
            ...
            <div className="hakkımızda" style={{minHeight:"40rem"}}>
                <h3 style={{textAlign:"center",color:"orange"}}><b>Hakkımızda</b></h3>
                <p className="kurumsal_text" >Temizliğe dair herhangi bir iş tamamlandıktan sonra siz değerli müşterilerimize yaptığımız işten memnun kalıp kalmadığnızı sormak çalışma prensiplerimizden ilkidir. 
