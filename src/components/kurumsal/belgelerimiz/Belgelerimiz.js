...
function Belgelerimiz() {
    ...
    return (
        ...
        <div className="hakkımızda" style={{minHeight:"40rem"}}>
            ...
            <h3 style={{textAlign:"center",color:"orange"}}><b>Belgelerimiz</b></h3>
            <p className="kurumsal_text" >İlgili resmi evraklar tamamlandıktan sonra belgelerimiz siz değerli müşterilerimizle ileriki zamanlarda paylaşılacaktır. Temizliğe dair herhangi bir iş tamamlandıktan sonra siz değerli müşterilerimize yaptığımız işten memnun kalıp kalmadığnızı sormak çalışma prensiplerimizden ilkidir. 
